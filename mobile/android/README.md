...
The Version 27.2 GitHub workflow publishes a debug-signed APK for direct Development-channel testing. Android may ask for permission to install an app downloaded outside Google Play. Future store or Stable distribution requires a persistent release-signing identity.
