...
## Version 30.11 Development

Version 30.11 keeps the complete signed Android Home, Companion, Federation, roaming-profile, one-tap-update, and Continuum feature set while desktop workstation controls move into the native LCARS System Control Matrix. Android default-Home selection, unknown-source permission, and package installation remain operating-system security surfaces by design; no duplicate launcher or Companion system is introduced.
