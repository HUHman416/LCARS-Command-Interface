...
DAILY_UTILITIES=DailyUtilities(CONFIG_DIR,"windows",HOME)
...
def integration_health():
    ...
    return {
        ...
        "voice":{"available":voice["available"],"detail":voice["reason"] or "Bundled offline whisper.cpp and English command model ready","remedy":"Reinstall Version 30 voice resources or select custom whisper.cpp files in Settings."},
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if route=="/api/daily-utilities":return self.send_json(DAILY_UTILITIES.status())
