...
def integration_health():
    ...
    return {
        ...
        "voice":{"available":voice["available"],"detail":voice["reason"] or "Bundled offline whisper.cpp and English command model ready","remedy":"Reinstall Version 30.13 voice resources or select custom whisper.cpp files in Settings."},
