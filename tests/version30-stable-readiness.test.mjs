...
test("Stable identity and signed release assets are consistent on every platform",async()=>{
  ...
  assert.match(linux,/LCARS_VERSION="30"/);
  assert.match(windows,/LCARS_VERSION="30"/);
