...
test("Version 28 identity and Connected Operations renderer are wired", () => {
  assert.match(read("package.json"), /"version": "(?:30\.6\.0-dev\.1|30\.4\.0-dev\.1|30\.3\.0-dev\.1|30\.2\.0-dev\.1|30\.1\.0-dev\.2|29\.0\.0|29\.3\.0-rc\.1|29\.2\.0-dev\.1|28\.0\.0)"/);
  assert.match(page, /LCARS_VERSION="(?:30\.[23456]|30\.1-A|29\.0\.0|29\.3\.0-rc\.1|29\.2\.0-dev\.1|28\.0\.0)"/);
