...
test('newer candidates retain Version 26.1 repository coverage',()=>{
  ...
  assert.match(page,/30\.13 DEV|30\.10 DEV|30\.8 DEV|30\.7 DEV|30\.6 DEV|30\.4 DEV|30\.3 DEV|30\.2 DEV|30\.1 DEV|29 STABLE|29\.3 RC 1|29\.2 DEVELOPMENT|28 STABLE|28\.3 RC 1|28\.2 DEV|27\.2(?:\.1)? DEV|27\.1(?:\.1)? DEV|26\.3 RC|26 STABLE/);
});
