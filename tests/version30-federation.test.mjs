...
test("Version 30.9 package and release channel are aligned", async () => {
  ...
  assert.match(page, /const LCARS_VERSION="30\.9"/);
  assert.match(android, /versionCode 309001/);
  assert.match(android, /versionName "30\.9\.0"/);
});
