...
test("Version 30.11 package and release channel are aligned", async () => {
  ...
  assert.match(page, /const LCARS_VERSION="30\.11"/);
  assert.match(android, /versionCode 3011001/);
  assert.match(android, /versionName "30\.11\.0"/);
});
