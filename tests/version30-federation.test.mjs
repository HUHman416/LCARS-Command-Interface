...
test("Version 31.1 package retains the Version 30 development history", async () => {
  ...
  assert.match(android, /versionCode 3104000/);
  assert.match(android, /versionName "31\.4\.0"/);
});
