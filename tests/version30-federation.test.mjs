...
test("Version 30.10 package and release channel are aligned", async () => {
  ...
  assert.match(page, /const LCARS_VERSION="30\.10"/);
  assert.match(android, /versionCode 3010001/);
  assert.match(android, /versionName "30\.10\.0"/);
});
