# LCARS 30.2 offline voice runtime
...
The bundled voice runtime is desktop-only in Version 30.2. A trusted PADD can submit commands through its paired station, but fully local Android inference is not included in this development milestone.
