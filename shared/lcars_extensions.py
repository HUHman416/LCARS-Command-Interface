...
def _download(url:str,limit:int,source=None):
    ...
    request=Request(url,headers={"User-Agent":"LCARS-Command-Interface-Module-API/30.5","Accept":"application/json"})
