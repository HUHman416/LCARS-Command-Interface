...
Version 30.6 is the current Development milestone and Version 29 remains Stable. The new Operations Center combines notices, station events, commands, Procedures, media changes, security prompts, and failures into a searchable chronological log with filters, acknowledgement, assignment, related-event grouping, “What changed?” explanations, privacy-filtered diagnostic export, safe rerun/reverse actions, and selected-station priority propagation. Explicit, player-aware media pause/resume now falls back across compatible MPRIS sessions, and rejected commands retain their exact retry action. Version 30.5 Universal Search and Data Fabric, Version 30.4 LCARS Session, Version 30.3 Module Platform, Version 30.2 Federation, and Version 30.1 Computer Core remain intact. See `docs/MODULE-API-v3.md` for the public module contract.
