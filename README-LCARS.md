...
Version 30.7 is the current Development milestone and Version 29 remains Stable. Operator identities now keep favorites, decks, themes, layouts, commands, and station preferences separate, enforce Guest/Operator/Administrator authority, support optional PINs, shared and restricted Away Team profiles, encrypted backups, and credential-free roaming over trusted encrypted Federation links. Media resume is verified against live MPRIS state, named Linux sources such as Spotify, Chromium/Chrome, Opera GX, Firefox, and VLC can be addressed directly, and local audio/video files can play inside the fullscreen LCARS Media Deck. Version 30.6 Operations Center, Version 30.5 Universal Search and Data Fabric, Version 30.4 LCARS Session, Version 30.3 Module Platform, Version 30.2 Federation, and Version 30.1 Computer Core remain intact. See `docs/MODULE-API-v3.md` for the public module contract.
