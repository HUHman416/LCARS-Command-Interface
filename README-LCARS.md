...
Version 30.11 is the current Development milestone and Version 29 remains Stable. It routes routine workstation configuration through a native LCARS System Control Matrix instead of KDE, GNOME, Windows Settings, system monitor, software center, file viewer, or media-player windows. Wi-Fi, supported Bluetooth operations, audio routing, displays, software inventories, processes, storage, module locations, and integrated media remain inside LCARS. Operating-system authorization prompts, Android default-Home and package-install permission screens, and the explicit emergency recovery desktop remain intentionally available because they are security or recovery boundaries. Version 30.10 Authoritative Session and all earlier Version 30 work remain intact. See `docs/VERSION-30.11-NATIVE-CONTROLS-AUDIT.md` for the handoff audit, `docs/VERSION-30.10-SESSION-AUDIT.md` for the session audit, and `docs/MODULE-API-v3.md` for the public module contract.
