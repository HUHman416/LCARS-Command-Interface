...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/development-v31.5-b69de8" alt="Development Version 31.5">
...
<p align="center">
  ...
  ·
  <a href="https://github.com/HUHman416/LCARS-Command-Interface/releases/tag/v31.5">Test Version 31.5</a>
  ·
...
> [!NOTE]
> **Version 31.5 Development is now active.** It adds a compact Daily Utilities page for private clipboard history, Portal-approved screenshots and screen recording, approved application notifications, and print-queue management. It also repairs Voice Control microphone permission handling and prevents duplicate requests from a single unmute. Version 30 remains Stable. See the [Version 31 roadmap](docs/VERSION-31-ROADMAP.md) and [31.5 implementation notes](docs/VERSION-31.5-DAILY-UTILITIES.md).
...
- Makes the Systems page itself safely scrollable beneath the fixed desktop shell, with clearance for the command tray, so Telemetry, Processes, Storage, and long inventories cannot be cut off.
- Audits every Systems panel for horizontal fit: network, wireless, Bluetooth, audio, displays, processes, storage, and modules use responsive record columns; Software uses paired inventory columns; Telemetry packs more processor cores into each row.
...
## 🧪 Version 30.2 Development — Federation
...
- Adds continuous hands-free offline voice capture. Push-to-talk remains selectable; disabling it automatically enables the independently configurable “Computer” wake word.
...
| 🔔 **Operator tools** | Search the entire environment with `Ctrl+F`, open Computer Core with `Ctrl+K`, build preview-first Procedures, map keyboard controls, review priority communications and command activity, and use Do Not Disturb |
